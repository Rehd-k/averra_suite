...
import 'view_materials.dart';

@RoutePage()
class RawMaterialIndex extends StatefulWidget {
  const RawMaterialIndex({super.key});

  @override
  RawMaterialIndexState createState() => RawMaterialIndexState();
}

class RawMaterialIndexState extends State<RawMaterialIndex> {
  ...
  final List<ColumnDefinition> _columnDefinitions = columnRmDefinitionMaps
            ...
            children: [
              Expanded(
                ...
                child: DropdownMenu<String>(
                  ...
                  dropdownMenuEntries: dropRmDownMaps
                      .map(
