...
class PdfReportService {
      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          return [
            ...
            _buildTable(tableHeaders, tableData),
            pw.SizedBox(height: 20),
            _buildFooter(data),
          ];
        },
    ...
    if (Platform.isAndroid) {
      ...
      if (status.isGranted) {
        ...
        if (await dir.exists()) {
          ...
          print('File saved to: ${downloadsFile.path}');
        }
      }
    }
  ...
  pw.Widget _buildTable(List<String> headers, List<List<dynamic>> data) {
  ...
  pw.Widget _buildFooter(List<Map<String, dynamic>> data) {
