...
class StoreNavigationScreen extends StatefulWidget {
  const StoreNavigationScreen({super.key});

  @override
  StoreNavigationState createState() => StoreNavigationState();
}

class StoreNavigationState extends State<StoreNavigationScreen> {
